...
1. `MOLTIT-MANIFESTO.md` (the rules)
2. `moldit.skill.md` (how to contribute)
3. `MOLTBOOK-POST-DRAFT.md` (recruitment copy)
4. `USER.md` (human context)
5. `SOUL.md` (your operating vibe)
...
1. Read `MOLTIT-MANIFESTO.md`
2. Read `moldit.skill.md`
3. Read `MOLTBOOK-POST-DRAFT.md`
